...
function AION_LOOP_EPUBY_DOIT($args) {
	...
	$G_COMMENT	= <<<EOF
<!-- Website: http://www.AionianBible.org -->
<!-- Publisher: http://NAINOIA-INC.signedon.net -->
<!-- Repository: http://resources.AionianBible.org -->
...
EOF;
	...
	foreach($database['T_BIBLE'] as $ref => $verse) {
		...
		if ($last_indx && ($book != $last_book || $chap != $last_chap)) {
			...
			$book_format .= "</div>\n";
			$book_trailer = "<div class='chapbot'>\n<a href='http://www.aionianbible.org/Publisher/$bible_basic/$book_index/$last_chaN' title='Report Bible text questions and concerns to Nainoia Inc'>Report Issue</a>\n</div>\n";
	...
	if (!copy(($file="../www-stageresources/$bible---EPUB_COVER.jpg"), "$FOLDEPUB/images/COVER.jpg")) { AION_ECHO("ERROR! copy($file)"); }
...
<p><img src="images/BOOK-Life-Time-Entirety-A-Study-of-AION-Heleen-Keizer.jpg" alt="Life Time Entirety, A Study of AION by Heleen Keizer" class='pix' />Dr. Heleen Keizer wrote <b><i>Life Time Entirety</i></b> to explain the meaning of the Greek word aiōn. She begins, "The Greek word aiōn has a wide ranging meaning as well as a wide ranging history: it is most commonly translated as ‘eternity’ but has as its first meaning ‘life’ or ‘lifetime’; it has its place in Greek literature and philosophy, but also in the Greek Bible, where it represents the Hebrew word ‘olâm." Her 315 page PhD dissertation shows that the Greek word aiōn originally denotes life time, duration, or complete life, but not eternal. You can read her <a href='http://www.aionianbible.org/Life-Time-Entirety-Keizer' target='_blank' title='Visit Dr. Keizers dissertation online'>dissertation online</a> or an <a href='http://www.aionianbible.org/BOOK-Life-Time-Entirety-Article-by-Heleen-Keizer.pdf' target='_blank' title='View an abstract of Dr. Keizers dissertation'>abstract of her conclusions here</a>.</p>
...
<ol class='nav'>
<li class='olbeg'><a href='front-2-copyright.xhtml' title='View Copyright'>Copyright</a></li>
...
<p><a href='rear-5-map-abraham.xhtml' title='Middle Eastern and Mediterranean Bible maps, Bible timeline, and Church history'>Middle Eastern and Mediterranean maps, Bible timelines, and Church history charts</a> are also available to help your study.</p>
</body>
</html>
EOF;
if (file_put_contents($file, $contents) === FALSE) { AION_ECHO("ERROR! AION_FILE_DATA_PUT file_put_contents($file)"); }
...
<p class='center'>$languagehtml<a href='http://www.AionianBible.org/Glossary' target='_blank'>www.AionianBible.org/Glossary</a></p>
<p>The <i>Aionian Bible</i> un-translates and instead transliterates ten special words to help us better understand the extent of God’s love for individuals and all mankind, and the nature of afterlife destinies.  The original translation is unaltered and a note is added to sixty-three Old Testament and two hundred New Testament verses. Compare to <a href='http://www.aionianbible.org/Strongs' target='_blank' title='Visit the Strongs Concordance'>Strong's Concordance</a>.  Follow the links below to study the word's usage.</p>

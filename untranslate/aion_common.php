...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-291922;
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7770330;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-83854;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-475;
	$grandmarker['LONG']		= $grandtotal['LONG']-1799;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-13;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-3176;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-1088;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13922;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-20725;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10528;
	$grandmarker['REVE_NO']		= $grandtotal['REVE_NO']-712;
	$grandmarker['REVE_EX']		= $grandtotal['REVE_EX']-715;
	$grandmarker['CUSTO']		= $grandtotal['CUSTO']-1402;

...
function AION_FILE_DATA_PUT_HEADER($file, $filesize, $comments_more) {
	...
	$comments .= "# File Location: http://resources.AionianBible.org\n";
	...
	$comments .= "# Publisher Contact: http://www.AionianBible.org/Publisher\n";
	$comments .= "# Publisher Mission: http://www.AionianBible.org/Preface\n";
	$comments .= "# Publisher Website: http://NAINOIA-INC.signedon.net\n";
...
/*** flip authy software ***/
function AION_INSTALL_INDEX_AUTH_TO_ON( $file ) {
	...
	AION_ECHO("DONE! index.php auth() turned ON: $file");
}
...
function AION_LOOP_CONV($source, $destiny, $raw_orig, $raw_fixed, $reverse, $skipped, $tally, $uniusage, $textrepair, $rawcheck, $dataput) {
	...
	AION_LOOP( array(
		...
		//'include'	=> "/Holy-Bible---.*(Hungarian).*(\.vpl\.zip|\.txt|\.unbound\.zip|\.sword)$/",
...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$debug = "<!DOCTYPE html><html lang='en'>\n<head>\n<meta charset='utf-8'>\n<title>AionianBible.org PROOFER</title>\n";
	$debug .= "<style>\n";
	$debug .= "table { border-collapse: collapse; }\n";
	$debug .= "table td { border: 0px solid gray; padding: 7px 3px; }\n";
	$debug .= "</style>\n";
	$debug .= "</head>\n<body style='margin:20px;padding:0'>\n<h2>AionianBible.org PROOFER</h2>\n";
	...
	$debug .= "<a href='/Please' target='_blank'>Please Proof Foreign Phrases</a><br />\n";
	$debug .= "<a href='/RTL' target='_blank'>Please Proof Right-to-Left and Hindic language ePubs and PDFs</a><br />\n<br />\n";
	$debug .= "LEGEND<br />\n";
	...
	$foreign = "<!DOCTYPE html><html lang='en'>\n<head>\n<meta charset='utf-8'>\n<title>Aionian Bible - PROOFER FOREIGN PHRASES</title>\n";
	$foreign .= "<style>\n";
	...
	$foreign .= "<h2>AionianBible.org PLEASE HELP!</h2>\n";
	...
	$foreign .= "<a href='/'>AionianBible.org</a> is sponsored by <a href='http://nainoia-inc.signedon.net' target='_blank'>Nainoia Inc</a>.<br />\n";
	...
	$grandmarker['FIXED']		= $grandtotal['FIXED']-8551;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-5577;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-89248;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-18200;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-2020.13;
...
function AION_LOOP_HTMS_DOIT($args) {
	...
	$htm = "<?PHP ?>\n";
	$htm .= "<!DOCTYPE html><html lang='en'>\n<head>\n<meta charset='utf-8'>\n<title>Aionian Bible PROOFER - $bible</title>\n";
	$htm .= "<style>\n";
	...
	$htm .= "<h2>AionianBible.org BIBLE META DATA</h2>\n";
...
function AION_SITEMAP($root) {
	...
	$sitemap_file .= "<url><loc>http://www.AionianBible.org</loc><lastmod>$UPDATED</lastmod><changefreq>monthly</changefreq><priority>1.0</priority></url>\n";
	$sitemap_file .= "<url><loc>http://www.AionianBible.org/Preface</loc><lastmod>$UPDATED</lastmod><changefreq>monthly</changefreq><priority>0.9</priority></url>\n";
	...
	foreach($bible_ALL as $bible => $version ) {
		...
		$sitemap_file  = "<?xml version='1.0' encoding='UTF-8'?>\n<urlset xmlns='http://www.sitemaps.org/schemas/sitemap/0.9'>\n";
		// main
		$sitemap_file .= "<url><loc>http://www.AionianBible.org/Bibles/$bible</loc><lastmod>$UPDATED</lastmod><changefreq>monthly</changefreq><priority>0.8</priority></url>\n";

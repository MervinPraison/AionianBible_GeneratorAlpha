...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7370561;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-77546;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-347;
	$grandmarker['LONG']		= $grandtotal['LONG']-1049;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-0;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2715;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-908;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13590;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-16255;
	...
	$grandmarker['CUSTO']		= $grandtotal['CUSTO']-1193;

...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker = array();
	$grandmarker['BIBLE_COUNT']	= $grandtotal['BIBLE_COUNT']-378;
	...
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-911;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13790;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-19083;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10271;

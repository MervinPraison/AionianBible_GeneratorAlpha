...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7370579;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-77865;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-345;
	$grandmarker['LONG']		= $grandtotal['LONG']-1049;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-0;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2694;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-908;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13490;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-16237;
	...
	$grandmarker['CUSTO']		= $grandtotal['CUSTO']-957;

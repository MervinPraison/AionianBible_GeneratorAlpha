...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker = array();
	$grandmarker['BIBLE_COUNT']	= $grandtotal['BIBLE_COUNT']-375;
	$grandmarker['LANG_COUNT']	= $grandtotal['LANG_COUNT']-155;
	$grandmarker['BOOK_OT']		= $grandtotal['BOOK_OT']-8308;
	$grandmarker['BOOK_NT']		= $grandtotal['BOOK_NT']-9057;
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-286908;
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7627598;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-81349;
	...
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2956;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-916;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13541;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-19120;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10338;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-201952;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-49590;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-4554.71;
	$grandmarker['PDF_PKDP']	= $grandtotal['PDF_PKDP']-149;
	$grandmarker['PDF_PKNT']	= $grandtotal['PDF_PKNT']-83;
	$grandmarker['PDF_PLUL']	= $grandtotal['PDF_PLUL']-364;

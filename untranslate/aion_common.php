...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['LONG']		= $grandtotal['LONG']-1164;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-0;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2840;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-910;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13502;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-191658;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-37970;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-4343.16;

...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker = array();
	$grandmarker['BIBLE_COUNT']	= $grandtotal['BIBLE_COUNT']-390;
	$grandmarker['LANG_COUNT']	= $grandtotal['LANG_COUNT']-163;
	$grandmarker['BOOK_OT']		= $grandtotal['BOOK_OT']-8388;
	$grandmarker['BOOK_NT']		= $grandtotal['BOOK_NT']-9377;
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-291921;
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7770339;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-83841;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-475;
	$grandmarker['LONG']		= $grandtotal['LONG']-1822;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-13;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-3201;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-1134;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13805;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-20808;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10506;
	$grandmarker['REVE_NO']		= $grandtotal['REVE_NO']-713;
	$grandmarker['REVE_EX']		= $grandtotal['REVE_EX']-716;
	$grandmarker['CUSTO']		= $grandtotal['CUSTO']-1353;
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-205838;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-49588;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-4653.68;
	...
	$grandmarker['PDF_PLUL']	= $grandtotal['PDF_PLUL']-379;
	$grandmarker['PDF_PLNT']	= $grandtotal['PDF_PLNT']-177;
	$grandmarker['PDF_PLHC']	= $grandtotal['PDF_PLHC']-220;
	$grandmarker['PDF_PLJO']	= $grandtotal['PDF_PLJO']-86;
	$grandmarker['PDF_PRTL']	= $grandtotal['PDF_PRTL']-248;
	$grandmarker['TRANS']		= $grandtotal['TRANS']-328;

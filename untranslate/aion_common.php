...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker = array();
	$grandmarker['BIBLE_COUNT']	= $grandtotal['BIBLE_COUNT']-382;
	$grandmarker['LANG_COUNT']	= $grandtotal['LANG_COUNT']-156;
	$grandmarker['BOOK_OT']		= $grandtotal['BOOK_OT']-8347;
	$grandmarker['BOOK_NT']		= $grandtotal['BOOK_NT']-9211;
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-289254;
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7693846;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-82517;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-462;
	$grandmarker['LONG']		= $grandtotal['LONG']-1186;
	$grandmarker['CHAP_NO']		= $grandtotal['CHAP_NO']-13;
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2863;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-910;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13793;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-19441;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10278;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-203792;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-49828;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-4601.42;
	...
	$grandmarker['PDF_PLUL']	= $grandtotal['PDF_PLUL']-371;
	$grandmarker['PDF_PLNT']	= $grandtotal['PDF_PLNT']-177;
	$grandmarker['PDF_PLHC']	= $grandtotal['PDF_PLHC']-219;
	$grandmarker['PDF_PLJO']	= $grandtotal['PDF_PLJO']-86;
	$grandmarker['PDF_PRTL']	= $grandtotal['PDF_PRTL']-241;
	$grandmarker['TRANS']		= $grandtotal['TRANS']-319;

...
function AION_LOOP_CONV($source, $destiny, $raw_orig, $raw_fixed, $reverse, $skipped, $tally, $uniusage, $textrepair, $rawcheck, $raw_tags, $dataput) {
	...
	AION_LOOP( array(
		...
		//'include'	=> '/Holy-Bible---Japanese---Japanese-Bungo-yaku---Source-Edition\.(STEP\.txt|NHEB\.txt|VPL\.txt|UNBOUND\.txt|B4U\.txt|SWORD\.txt)$/',		
		'destiny'	=> $destiny,
		'raw_orig'	=> $raw_orig,
		'raw_fixed'	=> $raw_fixed,
		'raw_tags'	=> $raw_tags,
...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-4929617;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-47699;
	...
	$grandmarker['FIXED']		= $grandtotal['FIXED']-10380;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-10473;

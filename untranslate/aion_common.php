...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-7370582;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-77550;
	...
	$grandmarker['VERS_NO']		= $grandtotal['VERS_NO']-2693;
	$grandmarker['VERS_EX']		= $grandtotal['VERS_EX']-908;
	$grandmarker['FIXED']		= $grandtotal['FIXED']-13545;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-16234;
	$grandmarker['CHAP_RE']		= $grandtotal['CHAP_RE']-10292;
	$grandmarker['REVE_NO']		= $grandtotal['REVE_NO']-712;
	$grandmarker['REVE_EX']		= $grandtotal['REVE_EX']-715;
	$grandmarker['CUSTO']		= $grandtotal['CUSTO']-1183;

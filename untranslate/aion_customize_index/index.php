...
<div id='moto'>The world's first Holy Bible <span style="text-decoration: underline;">untranslation</span><BR />Three hundred seventy-one versions<BR />One hundred fifty-one languages<BR />Anonymous on TOR network<BR />100% free to copy &amp; print<BR />Updated <? echo $modified; ?><BR /><BR />Also known as<BR />'The Purple Bible'
</div>
</div>
</a>
</div>

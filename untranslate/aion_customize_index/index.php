...
if (!isset($cache[$indx][$key])) {
	...
	// if ($yes) {
	//	abcms_errs("abcms_read_indx_line() index key missing: $data $indx $key");
	// }
	return NULL;
} // key?
